...
$this->Breadcrumbs->add([
    ['title' => 'Inicio', 'url' => '/'],
    ['title' => 'Empresas', 'url' => ['controller' => 'Business', 'action' => 'index']],
    ['title' => $busines->name]
])
?>
<div class="col-12">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                ...
                <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                    ...
                    <input type="hidden" id="id" value="<?= $busines->id ?>">
                </div>
            </div>
            ...
            <div class="column-responsive column-80">
                <div class="business form content">
                    ...
                    <?= $this->Form->button(__('Actualizar datos'), ['class' => 'btn btn-primary', 'id' => 'edit']) ?>
                    <?= $this->Form->end() ?>
                </div>
            </div>
        </div>
