...
<head>
    ...
    <?= $this->Html->css('https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.2.0/css/bootstrap.min.css') ?>
    <?= $this->Html->css('https://cdn.datatables.net/1.12.1/css/dataTables.bootstrap5.min.css') ?>
